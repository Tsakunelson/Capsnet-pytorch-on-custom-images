...
from torchvision import utils as vutils, transforms, datasets
...
def main():
    ...
    parser.add_argument('--batch-size', type=int, default=40,
                        help='training batch size. default=40')
    parser.add_argument('--test-batch-size', type=int,
                        default=40, help='testing batch size. default=40')
    ...
    parser.add_argument('--num-conv-in-channel', type=int, default=3,
                        help='number of input channels to the convolution. default=3')
    ...
    parser.add_argument('--primary-unit-size', type=int,
                        default=346112, help='primary unit size is 32 * 6 * 6. default=1152 --change to 346112-- as primary-unit-size')
    ...
    parser.add_argument('--input-width', type=int,
                        default=224, help='input image width to the convolution. default=28 for MNIST')
    parser.add_argument('--input-height', type=int,
                        default=224, help='input image height to the convolution. default=28 for MNIST')
    ...
    if args.cuda:
        ...
        print ('cuda is not there')
    # Load data
    # train_loader, test_loader = utils.load_data(dataset = 'mnist')
    ...
    train_data = datasets.ImageFolder('../newdataset/training',transform = train_transforms)
    test_data = datasets.ImageFolder('../newdataset/Validation', transform = test_transforms)
    ...
    if not os.path.exists('realDataResults/trained_model'):
        os.makedirs('realDataResults/trained_model')
